...
//        println(value)
    ...
    def sendMsg(triplet: EdgeTriplet[(Long,Int,Any,List[String],Int,String,Int,Any), _]): Iterator[(VertexId, (Long,Int,Any,List[String],Int,Int))] = {
      ...
      println("destinationVertex: "+destinationVertex)
      // check for icyclic
      println("=============================")
      println(sourceVertex._1+" "+triplet.dstId) //1335459677
      println(sourceVertex._1+" "+destinationVertex._1) //871779906
      println("=============================")
